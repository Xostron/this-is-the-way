...
!(function (e, r) {
	...
	;(r.initErrors = function (n) {
				...
				(function () {
					...
					if (e.addEventListener)
						...
						e.onerror = function (e, r, n, o, a) {
							s({ error: a || new Error(e || 'Empty error'), message: e, lineno: n, colno: o, filename: r }),
		...
		(r._getErrorData = function (n, t, o) {
			...
			return (
				o.debug && e.console && console[console[n.level] ? n.level : 'error']('[error-counter] ' + n.message, l, n.stack),
				{ path: n.path, vars: l }
			)
		}),
...
!(function () {
	...
	;(e = Ya.Rum).logError = function (r, o, s) {
		...
		for (
			var g = ['service', 'source', 'type', 'block', 'additional', 'level', 'page', 'method', 'sourceMethod', 'coordinates_gp'], i = 0;
			i < g.length;
			i++
		) {
			var n = g[i]
...
var initParams = {
	slots: [],
	reqid: '1779531926660%2F9a151ab5643c923bb090cbb2c40a14b9%2F1',
	service: 'mf-product',
	project: 'market_front_desktop',
	page: 'market:product-osku',
	env: 'production',
	platform: 'desktop',
	version: 'mf-product.2026.05.23.1.t4175169058',
	region: 10951,
	experiments: [
		'all_ultima-on-constructor',
		'all_streamer_urbanadssdk',
		'marketdj_common_prefix_enable_snippet_service_promo_trigger_model_card=1',
		'all_cart_snippet_k_plus_redesign',
		'all_snippet-constructor_cart-btn-squared=1',
		'touch_page-product_gallery_close-on-swipe',
		'all_new-sins-entrypoints',
		'all_checkout_rediz_old_payment_options',
		'dsk_search-filters_widened',
		'all_cart_shop_promo_hub',
		'all_business-info-cpr',
		'all_fintech_km_redesign',
		'all_order_consolidation',
		'all_cart_shop_groups',
		'all_mf-card',
		'all_crossborder_esia_binding_supported',
		'all_trigger_redesign',
		'all_compare_in_apphost',
		'all_bnpl_rediz_open_popup',
		'all_snippet-alternative-delivery',
		'all_snippet-constructor_kplus_special_tsar_badge',
		'dsk_frt-whl-game-goshan',
		'all_search_cr-incut-refresh=1',
		'all_cart_snippet_redesign',
		'dsk_redesign-sins-tabs-and-header',
		'desktop_new-sins-header',
		'all_suggest_discount',
		'all_unity_delivery_point_map',
		'all_vezdehod_main_feed_redesign',
		'touch_new-business-tabbar',
		'all-snippet-constructor-k-plus-redesign=1',
		'all_km_recom-snippets_with-reason-to-buy=1',
		'all_km-shop-info-block',
		'all_popup_login_agitation=withKMWidget',
		'all_ugc_master_reviews_page',
		'all_fintech_checkout_redesign_2',
		'all_snippet-constructor_hide-old-price',
		'all_checkout_recipient-refusal',
		'all_truth_express',
		'all_cart_desktop_shop_groups',
		'dsk_hero_lazy_apphost',
		'all_snippet-constructor_list-snippets-redesign=1',
		'all_snippet-constructor_become-cheaper_redesign',
		'all_new-business-page',
		'all_kkm_apphost',
		'marketdj_common_prefix_enable_snippet_service_promo_trigger=1',
		'all_fintech_split_uneven',
		'all_search-filters_size-filters-renewed',
		'all_fintech_checkout_redesign',
		'all_similar_items',
		'mblender_request_promoheader_from_custom_page_resolver=1',
		'all_delivery_friendly_checkout',
		'all_autopay_after_top_up',
	],
	additional: { puid: '108561552', runtimeClusterType: 'PRODUCTION' },
	yandexuid: '5469753741760961569',
	blocker: false,
}

initParams.transform = function (e) {
	if ([/ResizeObserver loop limit exceeded/, /ResizeObserver loop completed with undelivered notifications/].some((rule) => rule.test(e.message))) {
		return false
	}
	const transformedError = e
	const regex = /browser.([a-zA-Z\d]+)_([\w-]+)/i
...
window.Ya.Rum.initErrors(initParams)
